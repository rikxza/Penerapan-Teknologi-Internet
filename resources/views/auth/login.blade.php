            ...
            <div class="flex gap-6">
                ...
                <div class="w-1/2 glass-panel rounded-[32px] p-8 relative overflow-hidden min-h-[500px] hidden md:block">
                    ...
                    <div x-show="isLogin" 
                        ...
                        <div class="blob w-20 h-20 bg-gradient-to-br from-emerald-500 to-green-600 opacity-50 absolute top-32 left-24 float-animation-delay"></div>
                        ...
                        <div class="absolute -top-10 -left-10 w-40 h-40 rounded-full bg-gradient-to-br from-green-400/20 to-emerald-300/30 blur-2xl"></div>
                    </div>
                    ...
                    <div x-show="!isLogin"
                        ...
                        @if ($errors->any())
                            <div class="mb-4 p-4 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-600 dark:text-red-400 text-xs">
                        ...
                        <form action="{{ route('register') }}" method="POST" class="space-y-4">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="Full Name" 
                                    class="w-full bg-white/50 dark:bg-white/10 border border-emerald-200/50 dark:border-white/10 rounded-2xl pl-12 pr-4 py-3.5 text-sm text-emerald-900 dark:text-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all placeholder:text-emerald-600/50" required>
                            </div>
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-600/50">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <label for="terms" class="text-xs text-emerald-700/70 dark:text-emerald-300/70">
                                    I agree to the <span class="text-emerald-600 dark:text-emerald-400 underline cursor-pointer">Terms & Privacy</span>
                                </label>
                            </div>
                            <button type="submit" class="w-full money-gradient text-white font-black py-4 rounded-2xl text-sm uppercase tracking-wider shadow-lg shadow-emerald-500/30 transition-all hover:scale-[1.02] active:scale-[0.98]">
                                Create Account
                            </button>
                        </form>
                        <p class="mt-4 text-center text-sm text-emerald-700/60 dark:text-emerald-300/60">
                            Already have account? <button @click="isLogin = true" class="text-emerald-600 dark:text-emerald-400 font-bold hover:underline">Login</button>
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full md:w-1/2 glass-panel rounded-[32px] p-8 relative overflow-hidden min-h-[500px]">
                    ...
                    <div x-show="isLogin"
                        ...
                        <form action="{{ route('login') }}" method="POST" class="space-y-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" placeholder="Email" 
                                    class="w-full bg-white/50 dark:bg-white/10 border border-emerald-200/50 dark:border-white/10 rounded-2xl pl-12 pr-4 py-4 text-sm text-emerald-900 dark:text-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 outline-none transition-all placeholder:text-emerald-600/50" required>
                            </div>
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 -translate-y-1/2 text-emerald-600/50">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" name="remember" class="w-4 h-4 rounded border-emerald-300 text-emerald-500 focus:ring-emerald-500">
                                    <span class="text-sm text-emerald-700/70 dark:text-emerald-300/70">Remember me</span>
                                </label>
                                <a href="{{ route('password.request') }}" class="text-sm text-emerald-600 dark:text-emerald-400 hover:underline font-medium">Forgot Password?</a>
                            </div>
                            <button type="submit" class="w-full money-gradient text-white font-black py-4 rounded-2xl text-sm uppercase tracking-wider shadow-lg shadow-emerald-500/30 transition-all hover:scale-[1.02] active:scale-[0.98]">
                                Sign In
                            </button>
                        ...
                        <p class="mt-6 text-center text-sm text-emerald-700/60 dark:text-emerald-300/60">
                            Don't have an account? <button @click="isLogin = false" class="text-emerald-600 dark:text-emerald-400 font-bold hover:underline">Register</button>
                        </p>
                    </div>
                    ...
                    <div x-show="!isLogin"
                        ...
                        <div class="blob w-20 h-20 bg-gradient-to-br from-emerald-500 to-green-600 opacity-50 absolute bottom-32 left-24 float-animation-delay"></div>
                        ...
                        <div class="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-gradient-to-br from-green-400/20 to-emerald-300/30 blur-2xl"></div>
                    </div>
                </div>
            </div>
        </div>
